...
public class UserServiceTest {
    ...
    public void testRegisterUserAndFindUserProfile()
        ...
        UserProfile userProfile = userService.registerUser(
            "user", "userPassword",
            new UserProfileDetails("name", "lastName", "user@udc.es","33333333s",981888888,
                                "23/02/1989","normal",0));
    ...
    public void testRegisterDuplicatedUser() throws DuplicateInstanceException,
        ...
        UserProfileDetails userProfileDetails = new UserProfileDetails(
            "name", "lastName", "user@udc.es","33333333s",981888888,
                "23/02/1989","normal",0);
    ...
    public void testUpdate() throws InstanceNotFoundException,
        ...
        UserProfileDetails newUserProfileDetails = new UserProfileDetails(
            ...
            'X' + userProfile.getEmail(),'X' + userProfile.getDni(),
            'X' + userProfile.getTelefono(),'X' + userProfile.getFechaNacimiento(),
            'X' + userProfile.getTipoUsuario(),'X' + userProfile.getNumeroPuntos());
    ...
    public void testUpdateWithNonExistentUser()
        ...
        userService.updateUserProfileDetails(NON_EXISTENT_USER_PROFILE_ID,
            new UserProfileDetails("name", "lastName", "user@udc.es","33333333s",981888888,"23/02/1989","normal",0));
    ...
    private UserProfile registerUser(String loginName, String clearPassword) {
        ...
        UserProfileDetails userProfileDetails = new UserProfileDetails(
            "name", "lastName", "user@udc.es","33333333s",981888888,"23/02/1989","normal",0);
