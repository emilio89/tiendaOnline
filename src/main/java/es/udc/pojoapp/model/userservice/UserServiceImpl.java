package es.udc.pojoapp.model.userservice;
    ...
    public UserProfile registerUser(String loginName, String clearPassword,
        ...
        try {
            ...
            UserProfile userProfile = new UserProfile(loginName,
                    ...
                    userProfileDetails.getDni(),
                    userProfileDetails.getTelefono(), 
                    userProfileDetails.getFechaNacimiento(),
                    userProfileDetails.getTipoUsuario(),
                    userProfileDetails.getNumeroPuntos() );
